<?php
    ...
    $query = "SELECT * FROM employee WHERE Job ='Quản lý khóa học' ORDER BY EID DESC";
        ...
        <div class="row" style="background-color: #fff">
            <div class="col-md-3 pl-1"style="background-color: #fff">
                <div class="list-group ">
                    ...
                    <a href="./admincourse.php"  class="list-group-item list-group-item-action active">Quản lí khóa học</a>
