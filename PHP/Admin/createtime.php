<?php
    ...
    $sqlcskh = mysqli_query($con, "SELECT * FROM teacher WHERE ID ='{$_SESSION['unique_id']}'");
    ...
    $query = "SELECT * FROM teach WHERE TID='{$_SESSION['unique_id']}'";
        ...
        <div class="row" style="background-color: #fff">
            <div class="col-md-3 pl-1"style="background-color: #fff">
                <div class="list-group ">
                    ...
                    <a href="./createtime.php" class="list-group-item list-group-item-action active">Lịch Học</a>
...
<script>
    $(document).ready(function(){
        $('#editable_table').Tabledit({
            ...
            columns:{
            identifier:[0, "id"],
            editable:[[1, 'tid'],[2,'tname'], [3, 'ctime'],[4, 'date']]
        },
        restoreButton:false,
