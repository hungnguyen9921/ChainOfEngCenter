<?php
    ...
    $query = "SELECT * FROM employee WHERE Job ='Quản lý chi nhánh' ORDER BY Branch";
        ...
        <div class="row" style="background-color: #fff">
            <div class="col-md-3 pl-1"style="background-color: #fff">
                <div class="list-group ">
                    ...
                    <a href="./mainadmin.php"  class="list-group-item list-group-item-action active">Quản lí chi nhánh</a>
