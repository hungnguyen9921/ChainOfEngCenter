            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Yêu Cầu Của Học Viên</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <button type="button" class="btn btn-success deletecourse" style="color: #fff;">Tạo Yêu Cầu</button>
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                        <?php
                                           ...
                                           $sqlcourse =  mysqli_query($con, "SELECT * FROM request WHERE StudentID = '{$_SESSION['idStudent']}'");
                                            while($rowrequest = mysqli_fetch_assoc($sqlcourse)){
                                                $output='';
                                                $status = $rowrequest['Status'];
                                                $output.='<tr>
                                                <td>'.$count.'</td>
                                                <td>'.$rowrequest['CID'].'</td>
                                                <td>'.$rowrequest['StudentID'].' </td>
                                                <td>'.$rowstudent['Name'].'</td>
                                                <td>'.$rowrequest['Content'].'</td>
                                                ';
                                                if($status == 'Chưa chấp nhận'){
                                                    $output.= '<td>
                                                                <button type="button" class="btn btn-danger" style="color: #fff; 
                                                                ">Chưa Chấp Nhận</button>
                                                                </td>
                                                            </tr>';
                                                }
                                                else{
                                                    $output.= '<td>
                                                                ...
                                                                padding-right:18px;">Đã Chấp Nhận</button>
                                                                </td>
                                                            </tr>';
                                                }
                                                echo $output;
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModelLable" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#7ace4c; color:#fff;">
                    <h5 class="modal-title" id="exampleModelLable">Tạo Yêu Cầu</h5>
                    <button type="button" style="background-color:#7ace4c;color:#fff;" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <form action="addrequest.php" method="post">
                    <div class="modal-body">
                        <label for="email_address" class="col-md-4 col-form-label text-md-right">ID Khóa Học</label>
                        <input type="text" name="idcourse" id="idcourse">
                        <label for="email_address" class="col-md-4 col-form-label text-md-right">ID Học Viên</label>
                        <input type="text" name="idstudent" id="idstudent">
                        <label for="email_address" class="col-md-4 col-form-label text-md-right">Tên Học Viên</label>
                        <input type="text" name="namestudent" id="namestudent">
                        <label for="email_address" class="col-md-4 col-form-label text-md-right">Nội Dung</label>
                        <input type="text" name="content" id="content">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger dismissdelete" data-dismiss="modal">No</button>
                        <button type="submit" name="addrequest" class="btn btn-success aceptdelete">Yes</button>
                    </div>
                </form>
            </div>
        </div>
